...
description: Automated release coordination and deployment for seamless version management, testing, and deployment across multiple packages
type: development
color: "#FF6B35"
capabilities:
...
## Purpose
Automated release coordination and deployment for seamless version management, testing, and deployment across multiple packages.
...
- Memory coordination optimization`
  ...
  message: "release: Prepare v1.0.72 with GitHub integration and package enhancements"
}
```
...
Bash("cd /workspaces/ruv-FANN/packages/package-a && npm install")
Bash("cd /workspaces/ruv-FANN/packages/package-a && npm run test")
Bash("cd /workspaces/ruv-FANN/packages/package-a && npm run lint")
Bash("cd /workspaces/ruv-FANN/packages/package-a && npm run build")

Bash("cd /workspaces/ruv-FANN/packages/package-b && npm install")
Bash("cd /workspaces/ruv-FANN/packages/package-b && npm run test:all")
Bash("cd /workspaces/ruv-FANN/packages/package-b && npm run lint")

// Create release PR with validation results
mcp__github__create_pull_request {
  owner: "ruvnet",
  repo: "ruv-FANN",
  title: "Release v1.0.72: GitHub Integration and Package Enhancements",
  head: "release/v1.0.72", 
  base: "main",
  body: `## 🚀 Release v1.0.72

### 🎯 Release Highlights
- **GitHub Workflow Integration**: Complete GitHub command suite with coordinated workflows
...
### 📦 Package Updates
- **package-a**: v1.0.71 → v1.0.72
- **package-b**: v1.0.11 → v1.0.12

### 🔧 Changes
#### Added
- GitHub command modes: pr-manager, issue-tracker, sync-coordinator, release-manager
- Coordinated GitHub workflows
...
[Single Message - Complete Release Management]:
  ...
  Write("/tmp/release-v1.0.72/packages/package-a/package.json", "[updated package.json]")
  Write("/tmp/release-v1.0.72/packages/package-b/package.json", "[updated package.json]")
  ...
  Bash("cd /workspaces/ruv-FANN/packages/package-a && npm install && npm test && npm run lint && npm run build")
  Bash("cd /workspaces/ruv-FANN/packages/package-b && npm install && npm run test:all && npm run lint")
...
const versionStrategy = {
  ...
  minor: "New features, GitHub integration, package enhancements", 
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Install and Test
        run: |
          cd packages/package-a && npm install && npm test
          cd ../../packages/package-b && npm install && npm test:all
