...
description: Verify an open-source fork is fully sanitized before release. Scans for leaked secrets, PII, and internal references. Generates PASS/FAIL report. Second stage of the opensource-pipeline skill. Use before any public release.
