...
description: Fork any project for open-sourcing. Strips secrets, replaces internal references, generates .env.example, and cleans git history. First stage of the opensource-pipeline skill.
