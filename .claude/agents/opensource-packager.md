...
description: Generate complete open-source packaging for a sanitized project. Produces CLAUDE.md, setup.sh, README.md, LICENSE, and CONTRIBUTING.md. Third stage of the opensource-pipeline skill.
