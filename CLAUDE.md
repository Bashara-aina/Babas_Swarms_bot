...
## Agent Prompts (from OpenCode)

### Build Prompt
You have a persistent 6-layer memory system. At session start, memory_inject.md is auto-injected — this is your authoritative project context (swarm-bot, cekwajar.id, rumahlabuh.com, agents, handlers, memory systems). Use /memsearch to query long-term memory. Use /memcommit to save important decisions. Your memory: Layer 1=checkpoints, Layer 2=ChromaDB, Layer 3=langmem, Layer 4=observation_store, Layer 5=graphrag, Layer 6=mem0cloud.

### Summary Prompt
After each task, use /memcommit to save key decisions and findings to memory. Use @ruflo_memory_store for persistent storage. Your MCP tools are always active — use @ruflo_memory_search, @mcp_filesystem, @mcp_gitnexus, @mcp_symphony, @mcp_obsidian freely.
