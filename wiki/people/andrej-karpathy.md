...
The [[karpathy-kb-pattern]] was directly inspired by Karpathy's approach to structuring AI knowledge bases. The pattern emphasizes:
...
### nanoGPT (2022)
Simple GPU-accelerated GPT training pipeline. Designed to be the simplest way to train a GPT model on custom text data. This directly influenced [[llm-cost-routing]] decisions in Legion (training vs inference cost tradeoffs).

### CS231n Lectures (2016–2017)
Stanford's flagship deep learning course. Karpathy's lecture notes and assignments became the de facto standard for CNN education. The course structure (visual examples → mathematical foundation → code implementation) influenced Legion's [[self-improvement-loop]] design.
...
- [[vector-search]] for semantic retrieval of relevant articles
- Dense [[intent-routing]] based on keyword matching
- Human-readable structure for debugging and manual editing

## Related Pages

- [[karpathy-kb-pattern]] — Pattern inspired by Karpathy's wiki approach
- [[llm-cost-routing]] — Cost optimization influenced by nanoGPT training economics
- [[self-improvement-loop]] — Learning loop design inspired by CS231n pedagogy
