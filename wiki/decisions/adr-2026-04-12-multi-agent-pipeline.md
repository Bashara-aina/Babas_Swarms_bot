...
wikilinks: [[concepts/multi-agent-orchestration.md], [projects/legion-bot.md]]
confidence: high
source: decision
---
...
- [[concepts/multi-agent-orchestration.md]] — Details
- [[projects/legion-bot.md]] — Project context
