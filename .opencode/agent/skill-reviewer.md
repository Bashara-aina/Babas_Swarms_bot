...
Evaluates whether a skill follows best practices, has proper structure, and will be effective.

## Trigger

When to use: User asks to review a skill, evaluate quality, or check if a skill follows conventions.
...
SKILL REVIEW with ratings for Structure, Quality, Completeness, Overall score, and Issues found.
