...
Create new skills following the skill template with proper frontmatter, prompt structure, and examples.

## Trigger

When to use: User wants to create a new skill, generate a skill file, or add a capability to the skill system.
...
Created skill file path(s) with confirmation of template compliance and all required sections present.
