...
def _build_browser_llm(model: str | None = None) -> Any:
    ...
    minimax_model = model or os.getenv("BROWSER_USE_MODEL", "minimax-coding-plan/MiniMax-M2.7")
    if "/" in minimax_model:
...
class BrowserUseAgent:
    ...
    def __init__(
        ...
        self.model = model or os.getenv("BROWSER_USE_MODEL", "minimax-coding-plan/MiniMax-M2.7")
