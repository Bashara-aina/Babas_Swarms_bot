...
DEFAULT_MODEL = "opencode-go/minimax-m3"  # type: ignore[reportOptionalMemberAccess]
...
def _build_langmem_llm(model: str | None = None) -> Any:  # type: ignore[reportOptionalMemberAccess]
    ...
    if "/" in model_name:
        model_name = model_name.split("/")[1]  # extract "MiniMax-M3" from "opencode-go/minimax-m3"
