...
class SwarmBotMemoryManager:
    ...
    def _get_manager(self) -> Any:  # type: ignore[reportOptionalMemberAccess]
        ...
        if self._manager is None:  # type: ignore[reportOptionalMemberAccess]
            ...
            self._manager = langmem.create_memory_store_manager(  # type: ignore[reportOptionalMemberAccess]
                ...
                instructions=(  # type: ignore[reportOptionalMemberAccess]
                    "You are a long-term memory manager for SwarmBot. "  # type: ignore[reportOptionalMemberAccess]
                    "Extract facts about user preferences, agent capabilities, "  # type: ignore[reportOptionalMemberAccess]
                    "conversation context, and procedural knowledge. "  # type: ignore[reportOptionalMemberAccess]
                    "Store memories with confidence levels and reasoning."  # type: ignore[reportOptionalMemberAccess]
                ),  # type: ignore[reportOptionalMemberAccess]
                enable_inserts=True,  # type: ignore[reportOptionalMemberAccess]
                enable_deletes=True,  # type: ignore[reportOptionalMemberAccess]
            )
