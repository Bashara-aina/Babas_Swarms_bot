...
class RecursiveMASOrchestrator:
    ...
    def setup_sequential_style(
        self,
        planner_model: str = "minimax-coding-plan/MiniMax-M2.7",
        critic_model: str = "minimax-coding-plan/MiniMax-M2.7",
        solver_model: str = "minimax-coding-plan/MiniMax-M2.7",
    ) -> None:
    ...
    def setup_mixture_style(
        self,
        math_model: str = "minimax-coding-plan/MiniMax-M2.7",
        code_model: str = "minimax-coding-plan/MiniMax-M2.7",
        science_model: str = "minimax-coding-plan/MiniMax-M2.7",
        summarizer_model: str = "minimax-coding-plan/MiniMax-M2.7",
    ) -> None:
    ...
    def setup_distillation_style(
        self,
        expert_model: str = "minimax-coding-plan/MiniMax-M2.7",
        learner_model: str = "minimax-coding-plan/MiniMax-M2.7",
    ) -> None:
    ...
    def setup_deliberation_style(
        self,
        reflector_model: str = "minimax-coding-plan/MiniMax-M2.7",
        tool_caller_model: str = "minimax-coding-plan/MiniMax-M2.7",
    ) -> None:
