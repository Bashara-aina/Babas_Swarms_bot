...
_LEGACY_AGENT_MODELS: dict[str, str] = {
    ...
    "coding": "minimax-coding-plan/MiniMax-Text-01",
    "debug": "minimax-coding-plan/MiniMax-Text-01",
    "math": "minimax-coding-plan/MiniMax-Text-01",
    "architect": "minimax-coding-plan/MiniMax-Text-01",
    "analyst": "minimax-coding-plan/MiniMax-Text-01",
    "computer": "minimax-coding-plan/MiniMax-Text-01",
    "general": "ollama_chat/gemma4:e4b",
    "researcher": "minimax-coding-plan/MiniMax-Text-01",
    "marketer": "minimax-coding-plan/MiniMax-Text-01",
    "devops": "minimax-coding-plan/MiniMax-Text-01",
    "pm": "minimax-coding-plan/MiniMax-Text-01",
    "humanizer": "minimax-coding-plan/MiniMax-Text-01",
    "reviewer": "minimax-coding-plan/MiniMax-Text-01",
    "think": "minimax-coding-plan/MiniMax-M2.7",
    "owl": "minimax-coding-plan/MiniMax-Text-01",
    "ag2_researcher": "minimax-coding-plan/MiniMax-Text-01",
    "ag2_critic": "minimax-coding-plan/MiniMax-Text-01",
    "ag2_synthesizer": "minimax-coding-plan/MiniMax-Text-01",
    ...
    "debate": "minimax-coding-plan/MiniMax-Text-01",
}
...
LEGACY_FALLBACK_CHAIN: dict[str, list[str]] = {
    ...
    "vision": ["minimax-coding-plan/MiniMax-M2.7", "ollama_chat/gemma4:e4b"],
    "computer": ["minimax-coding-plan/MiniMax-M2.7", "ollama_chat/gemma4:e4b"],
    # All other agents: MiniMax primary only
    # FIXED: Use correct litellm model_id values from config
    "coding": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "debug": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "math": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "architect": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "analyst": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "general": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "researcher": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "marketer": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "devops": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "pm": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "humanizer": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "reviewer": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "think": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "owl": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "ag2_researcher": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "ag2_critic": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "ag2_synthesizer": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "code_exec": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "predictor": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "claude_orchestrator": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
    "debate": ["minimax-coding-plan/MiniMax-M2.7", "minimax-coding-plan/MiniMax-Text-01"],
}
