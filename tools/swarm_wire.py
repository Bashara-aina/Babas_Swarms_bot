...
async def _llm_call(
    ...
    Args:
        model:       litellm model string, e.g. 'opencode-go/minimax-m3'
...
async def _run_department(
    ...
    async def _agent_call(agent_name: str, agent_persona: str) -> str:
        ...
        model = AGENT_MODELS.get("general", "opencode-go/minimax-m3")
    ...
    lead_model = AGENT_MODELS.get("architect", "opencode-go/minimax-m3")
