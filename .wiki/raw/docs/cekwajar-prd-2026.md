---
title: cekwajar-prd-2026
type: reference
status: active
tags: [cekwajar, prd, product-requirements, master-prd, wajar-slip, wajar-gaji]
created: 2026-04-13
updated: 2026-04-13
...
> **⚠️ NOTE**: Per [ADR-2026-04-13-cekwajar-mvp-scope-lock](file://wiki/decisions/adr-2026-04-13-cekwajar-mvp-scope-lock.md), v1 MVP scope is locked to **Wajar Slip only**. Sections 5-8 (Wajar Gaji, Wajar Tanah, Wajar Kabur, Wajar Hidup) describe future tools not in MVP.
...
This document is a raw copy of `req_01_master_prd.md` from the cekwajar project source documents, dated January 2024. For the current MVP scope decision, see [ADR-2026-04-13-cekwajar-mvp-scope-lock](file://wiki/decisions/adr-2026-04-13-cekwajar-mvp-scope-lock.md).
