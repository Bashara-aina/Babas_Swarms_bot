---
{
  "page_path": "/home/newadmin/swarm-bot/.wiki/tools/openaugi/docs/task-dispatch.md",
  "reason": "daily_fast_scan: verdict=REJECT, score=0.000 < 0.3",
  "score": 0.0,
  "quarantined_at": "2026-05-07T01:00:00.993706"
}
---
...
created: '2026-04-14'
updated: '2026-04-14'
summary: Write a task in Obsidian (on desktop or mobile). A watcher picks it up and
  launches a Claude Code agent in a named tmux session to do the work. Attach any
  time with `tmux attach -t <task_id>` to wa...
wikilinks: []
confidence: medium
source: research
---
