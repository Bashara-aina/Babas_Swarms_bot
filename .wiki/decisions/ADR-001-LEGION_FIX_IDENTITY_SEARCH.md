...
2. **Language contamination**: "" (Chinese "curious") leaked into Indonesian response 
...
**Verify**: `python -c "from core.character_enforcer import enforce_language; r = enforce_language('kamu'); assert '' not in r and 'penasaran' in r; print('OK')"`
...
**Verify**: `python -c "from core.character_enforcer import enforce_character; r = enforce_character('testresponse'); assert '' not in r; print('OK')"`
