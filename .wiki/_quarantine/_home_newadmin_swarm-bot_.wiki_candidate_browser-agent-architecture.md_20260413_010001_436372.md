---
{
  "page_path": "/home/newadmin/swarm-bot/.wiki/candidate/browser-agent-architecture.md",
  "reason": "daily_fast_scan: verdict=REJECT, score=0.000 < 0.3",
  "score": 0.0,
  "quarantined_at": "2026-04-13T01:00:01.436393"
}
---
...
| `yt-dlp` subprocess | 60s |
| `proc.communicate()` (video) | 60s |
| Audio download (video) | 120s |
...
| Function | Returns | Timeout | SSRF |
|----------|---------|---------|------|
| `check_site_health(url)` | dict | 15s goto | ❌ NONE |
| `browse_task(task, max_steps)` | dict | ~200s | ❌ NONE |
| `_playwright_fallback(task)` | dict | 15s goto | ❌ NONE |
| `format_health_for_prompt(health)` | str | — | — |
