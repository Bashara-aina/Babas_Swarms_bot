...
created: '2026-04-14'
updated: '2026-04-14'
summary: FPN solves the **multi-scale detection problem** that plagues single-scale
  feature maps. Low-level features (C2, C3) have high resolution but limited semantic
  content; high-level features (C5) have...
wikilinks: []
confidence: medium
source: research
---
