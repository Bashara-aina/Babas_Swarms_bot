...
created: '2026-04-14'
updated: '2026-04-14'
summary: CoNeS introduced **Conditional Neural Fields (CoNF)** with **shift modulation**
  — a novel approach using MLPs as decoders (neural fields) instead of CNNs, conditioned
  on source images via shift mod...
wikilinks: []
confidence: medium
source: research
---
